...
void MapScripts::OnLoadObject(CKSTRING filename, BOOL isMap, CKSTRING masterName,
	CK_CLASSID filterClass, BOOL addtoscene, BOOL reuseMeshes, BOOL reuseMaterials,
	BOOL dynamic, XObjectArray* objArray, CKObject* masterObj) {
	if (isMap) {
#define FILL_MAP(FUNC) { \
	mapScripts[func_addr(&MapScripts::FUNC)] \
		= m_bml->GetScriptByName("BML_" TOSTRING(FUNC)); \
	}
